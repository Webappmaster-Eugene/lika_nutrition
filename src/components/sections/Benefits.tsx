    ...
    >
      <div className="container mx-auto w-full max-w-full">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-sage-900 mb-3 xs:mb-4 leading-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-5 sm:gap-6">
            {benefits.map((benefit, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="bg-white p-5 xs:p-6 rounded-2xl shadow-md border border-beige-200 hover:shadow-lg hover:border-sage-300 transition-all duration-300"
                ...
                >
                  <div className="w-12 h-12 bg-sage-100 rounded-xl flex items-center justify-center mb-4">
                    {IconComponent && <IconComponent className="w-6 h-6 text-sage-700" />}
                  </div>
